...
[hanyazou 氏の a-p-prog](https://github.com/hanyazou/a-p-prog)のコピー。
自分に必要なところを変更するため。hanyazou 氏のところには issue が用意されてなくて、どうや
って伝えたら良いのか分からなかったのと、フォークすると上流の変更がうんたらかんたら、
とかいうのが、まるっきり理解できなかったので、github のフォーク機能でのフォークではなく、
手でコピー。

もしかしたら私の変更が誰かの役に立つことがあるかもしれないので、一応公開。でも、万一誰かが
pull request とかしてきても、一切対処方法が分からないので、一切なにもしない。そういうのは
勝手に別でやってください。
