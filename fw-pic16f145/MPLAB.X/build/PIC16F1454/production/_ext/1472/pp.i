...
# 27 "../pp.c" 2
# 1 "../../fw/pp/pp_ops/fw_pp_ops.h" 1
# 37 "../../fw/pp/pp_ops/fw_pp_ops.h"
enum {
    OP_NONE,
    OP_IO_MCLR,
    OP_IO_DAT,
...
# 1 "../../fw/pp/pp_ops/fw_pp_ops.c" 1
# 26 "../../fw/pp/pp_ops/fw_pp_ops.c"
...
void send_bits(uint8_t d, uint8_t len)
{
    ...
    for (uint8_t i = 0; i < len; i++) {
        do { LATA4 = (d & 0x80) ? 1 : 0; } while(0);
        do { __nop(); } while(0);
        do { LATA5 = ((1) ? 1 : 0); } while(0);

        d <<= 1;
        do { LATA5 = ((0) ? 1 : 0); } while(0);
        do { LATA4 = (0) ? 1 : 0; } while(0);
    }
}
...
void exec_ops(uint8_t *ops, int len)
{
    ...
    while (ops < endp) {
        ...
        case OP_IO_MCLR:
            do { } while(0);
            do { LATC3 = (n & 0x01) ? 1 : 0; } while(0);
            break;
        case OP_IO_DAT:
            do { } while(0);
            if (n & 0x02) {
                do { LATA4 = (n & 0x01) ? 1 : 0; } while(0);
                do { TRISA4 = 0; } while(0);
            } else {
                do { TRISA4 = 1; } while(0);
            }
        ...
        case OP_READ_ISP:
            ...
            while (0 < n--) {
                for (i = 0; i < 8; i++) {
                    ...
                    do { LATA5 = ((0) ? 1 : 0); } while(0);
                    do { __nop(); } while(0);
                    d = (uint8_t)(d << 1) | (((PORTAbits.RA4)) ? 1 : 0);
                }
                do { sendback(d); } while(0);
            }
            break;
        case OP_WRITE_ISP:
            do { } while(0);
            ...
            do { uint8_t count = (3); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);
            break;
        case OP_READ_ISP_BITS:
            ...
            while (0 < n--) {
                ...
                do { uint8_t count = (pp_params[PP_PARAM_DELAY1]); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);
                ...
                do { uint8_t count = (pp_params[PP_PARAM_DELAY2]); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);

                send_bits(pp_params[PP_PARAM_CMD2], pp_params[PP_PARAM_CMD2_LEN]);
                do { uint8_t count = (pp_params[PP_PARAM_DELAY3]); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);

                for (i = 0; i < txbuf_len; i++) {
                    do { } while(0);
                    do { sendback(txbuf[i]); } while(0);
                }
            }
            break;
        ...
        case OP_DELAY_US:
            do { } while(0);
            do { uint8_t count = (n); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);
            break;
        case OP_DELAY_10US:
            do { } while(0);
            while (0 < n--)
                do { uint8_t count = (10); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);
            break;
        case OP_DELAY_MS:
            do { } while(0);
            n10 = n * 10;
            while (0 < n10--)
                do { uint8_t count = (100); while (0 < count--) { __nop(); __nop(); __nop(); } } while(0);
            break;
        case OP_REPLY:
            do { } while(0);
            do { sendback(n); } while(0);
            break;
        case OP_PARAM_SET:
            do { } while(0);
            pp_params[n] = ops[2];
